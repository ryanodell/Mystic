...
namespace MysticEngineTK {
    internal class BufferAbstraction : Game {
        public BufferAbstraction(int initialWindowWidth, int initialWindowHeight, string initialWindowTitle) : base(initialWindowWidth, initialWindowHeight, initialWindowTitle) { }
        ...
        private readonly float[] _vertices =
{
        ...
        protected override void LoadContent() {            
            ...
            BufferLayout test = new BufferLayout();
            //Positions
            test.Add<float>(3);
            //Texture Coordinates
            test.Add<float>(2);
