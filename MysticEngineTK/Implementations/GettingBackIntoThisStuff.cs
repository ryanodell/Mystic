...
namespace MysticEngineTK {
    internal class GettingBackIntoThisStuff : Game {
        public GettingBackIntoThisStuff(int initialWindowWidth, int initialWindowHeight, string initialWindowTitle) : base(initialWindowWidth, initialWindowHeight, initialWindowTitle) { }
        //36
        private float[] _vertices = new float[36];
        ...
        protected override void LoadContent() {
            _texture = ResourceManager.Instance.LoadTexture("Resources/Textures/kruggsmash.png");

            float x = 1, y = 15;
            float spriteWidth = 32, spriteHeight = 32;
