...
namespace MysticEngineTK {
    internal class PassingInColorExample : Game {
        public PassingInColorExample(int initialWindowWidth, int initialWindowHeight, string initialWindowTitle) : base(initialWindowWidth, initialWindowHeight, initialWindowTitle) { }
