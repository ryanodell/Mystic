...
namespace MysticEngineTK {
    internal class TextureWithColor : Game {
        public TextureWithColor(int initialWindowWidth, int initialWindowHeight, string initialWindowTitle) : base(initialWindowWidth, initialWindowHeight, initialWindowTitle) { }
